...
@interface RefreshTableView : UITableView<GEGORefreshTableDelegate,UITableViewDataSource,UITableViewDelegate>


@property (nonatomic,retain)GEGORefreshTableHeaderView * refreshHeaderView;
